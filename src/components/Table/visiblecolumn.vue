<template>
    <div>
        ...
        <!------------------------------- Visible-columns-custom-top-and-fullscreen code start ----------------->
<div class="q-pa-md row1">
        <div class="column">
          <div class="col">
            <q-card  class="my-card">
              <q-card-section>
                <div class="text-h6">Visible columns custom top and fullscreen</div>
    ...
    >
      <template v-slot:top="props">
        ...
        />
          ...
          <!------------------------------- Visible-columns code start ----------------->
<div class="q-pa-md row1">
        <div class="column">
          <div class="col">
            <q-card  class="my-card">
              <q-card-section>
                <div class="text-h6">Visible columns </div>
                <div class="text-subtitle2">
                         <div class="q-pa-md">
    <q-table
      title="Treats"
